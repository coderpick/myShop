    ...
    <div class="admin-content">
        ...
        <div class="data-table-wrapper">
            <div class="data-table-header">
                <h6><i class="bi bi-box-seam me-2"></i>Edit Sub Category</h6>
            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control"
                                    placeholder="Category Name" value="{{ $subCategory->name ?? old('name') }}">
                                @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="slug" id="slug" class="form-control"
                                    placeholder="Category Slug" value="{{ $subCategory->slug ?? old('slug') }}">
                                @error('slug')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
